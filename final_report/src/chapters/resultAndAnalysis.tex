...
\begin{figure}[H]
    \centering
    % Note: You can replace this with an actual image export from WandB 
    % or use the pgfplots code below if you want LaTeX to draw it.
    \includegraphics[width=0.8\textwidth]{src/images/plots/validation_loss.png}
    \caption{Training and Validation Loss Trajectory over 700 Steps.}
