...
This appendix presents the implementation of hyperparameter optimization using Optuna for fine-tuning the LLaMA-2-7B model with QLoRA. 
...
\section{Fine-Tuning}
This appendix presents the implementation of the fine-tuning process using QLoRA.
