...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{src/images/figures/Data-flow.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{src/images/figures/gpu_usage.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{src/images/figures/train_loss_vs_eval_loss.png}
