...
Here is the implementation of removal of comments and docstring present in the dataset.

\begin{lstlisting}[style=cleanpython, caption={Removal of Comments and Docstrings}, label={lst:optuna}]
...
\subsection{Filteration of function only code}
Here is the implementation of filteration of function only code present in the dataset.
\begin{lstlisting}[style=cleanpython, caption={Filteration of Function Only Code}, label={lst:optuna}]
...
\begin{lstlisting}[style=cleanpython, caption={Hyperparameter Optimization with Optuna}, label={lst:optuna}]
...
\begin{lstlisting}[style=cleanpython, caption={Fine-Tuning Implementation}, label={lst:optuna}]
...
train_dataset = train_dataset.map(lambda x: preprocess_function_with_masking
                (x, tokenizer, config.max_seq_length), batched=True, 
                remove_columns=dataset.column_names)
eval_dataset = eval_dataset.map(lambda x: preprocess_function_with_masking
                (x, tokenizer, config.max_seq_length), batched=True, 
                remove_columns=dataset.column_names)
